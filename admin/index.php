...
<div class="ch-container" style="background: black;">
    ...
    <div class="row">
        ...
        <div class="col-md-12 center login-header">
            ...
            <h2>Admin Login to Crime Detection</h2>
            <button class="btn btn-default"><a href="../index.php">Login Users</a></button>
        </div>
        <!--/span-->
    </div><!--/row-->
...
$result = mysqli_query($conn,$query);
      ...
      if ($count > 0) {
                           ...
                           // header('location:login_home.php');
                            mysqli_query($conn,"Insert into logs_tb(user_id,ip,command,description,date_accessed) VALUES('$ids','$ips','Login','Login as Admin',now())") or die(mysqli_error($conn));
                $URL="dashboard.php";
