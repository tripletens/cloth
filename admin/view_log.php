...
<div class="ch-container">
 ...
 <?php include('side_bar.php');?>
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> Server Monitoring Page</h2>
    ...
    <div class="alert alert-info">All Logs</div>
    ...
    <tbody>
         <?php
            $query = mysqli_query($conn,"select * from logs_tb") or die(mysqli_error());
             while ($row = mysqli_fetch_array($query)) {
                $userid=$row['user_id'];
                $query2 = mysqli_query($conn,"select * from user_tb") or die(mysqli_error());
                $row2 = mysqli_fetch_array($query2);                 
        ?>
    <tr>
        <td class="center"><?php echo $row['user_id']; ?></td>
        <td class="center"><?php echo $row2['fullname']; ?></td>
        <td class="center"><?php echo $row['ip']; ?></td>
        <td class="center"><?php echo $row['date_accessed']; ?></td>
         <td class="center"><?php echo $row['command']; ?></td>
