...
<div class="ch-container">
 ...
 <?php include('side_bar.php');?>
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> View Member Records</h2>
    ...
    <div class="alert alert-info">All the Registered Members</div>
    ...
    <tbody>
         <?php
            $query = mysqli_query($conn,"select * from user_tb") or die(mysqli_error());
    ...
    <tr>
        ...
        <td class="center"><?php echo $row['qualification']; ?></td>
        ...
        <td class="center">
            ...
            <a class="btn btn-danger" onclick="return confirm('Are you sure you want to Delete <?php echo $row['fullname']; ?>?');" href="delete_user.php?id=<?php echo $row['user_id']; ?>">
