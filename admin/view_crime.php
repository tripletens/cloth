...
<div class="ch-container">
 ...
 <?php include('side_bar.php');?>
    ...
    <div class="alert alert-info">All the Registered Crimes</div>
    ...
    <tbody>
         <?php
            $query = mysqli_query($conn,"select * from crime_tb") or die(mysqli_error());
    ...
    <tr>
        ...
        <td class="center">
            ...
            <a class="btn btn-danger" onclick="return confirm('Are you sure you want to Delete <?php echo $row['name']; ?> for <?php echo $row['type_case']; ?> ?');" href="delete_crime.php?id=<?php echo $row['cirme_id']; ?>">
                <i class="glyphicon glyphicon-trash icon-white"></i>
                Delete
            </a>

            <a class="btn btn-success" onclick="return confirm('Do you want to View this Crime  for <?php echo $row['type_case']; ?> ?');" href="view_crime_ind.php?id=<?php echo $row['cirme_id']; ?>">
